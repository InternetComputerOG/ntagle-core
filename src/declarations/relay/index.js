...
import { idlFactory } from './relay.did.js';
export { idlFactory } from './relay.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.RELAY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./relay.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the relay canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./relay.did.js")._SERVICE>}
 */
export const relay = createActor(canisterId);
