...
import { idlFactory } from './SDM.did.js';
export { idlFactory } from './SDM.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SDM_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./SDM.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the SDM canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./SDM.did.js")._SERVICE>}
 */
export const SDM = createActor(canisterId);
